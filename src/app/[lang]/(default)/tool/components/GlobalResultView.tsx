...
const GlobalResultView = ({
  ...
  data: InstagramResponse | TiktokResponse | FacebookVideoResponse;
                            ...
                            <div className="rounded-xl border border-neutral-800 bg-gradient-to-br from-[#1e1e1e] to-[#121212] shadow-lg p-4 flex gap-4 items-center hover:scale-[0.97] transition-transform cursor-pointer">
                              ...
                              <div className="flex-1 flex flex-col justify-between">
                                <div className="flex items-center gap-1 mb-1">
                                  ...
                                  {res.type === "video" &&
                                    "has_watermark" in res &&
                                    res.has_watermark && (
                                      <Tooltip delayDuration={0}>
                                        <TooltipTrigger asChild>
                                          <span className="text-xs bg-green-800/40 px-2 py-0.5 rounded-full">
                                            <Droplet
                              ...
                              {res?.type === "image" ? (
                                ...
                                <VideoPlayer
                                  source={{
                                    ...
                                    type: "video",
                                    previewThumbnails: { src: res.thumbnail },
                                  }}
                                ></VideoPlayer>
                              )}
                            </DialogFooter>
...
export default GlobalResultView;
